...
function crearConfiguracionSesion(entorno = process.env) {
  return {
    ...
    instructions: [
      ...
      "Atiendes en español de España, inglés o francés, con tono amable, natural y breve.",
      "El idioma inicial es español. Si el cliente pide hablar en inglés o francés, o comienza claramente en uno de esos idiomas, úsalo durante el resto de la sesión. Solo cambia otra vez si lo pide expresamente.",
      ...
      "En mensaje escribe en español la misma petición para que la procese el motor determinista. Si el cliente habla inglés o francés, tradúcela al español sin añadir, eliminar ni inferir datos.",
      "Si al inicio el cliente dice únicamente English o pide hablar en inglés, usa mensaje hola para que el motor repita las opciones y establece idioma en. Si dice Français, French o pide hablar en francés, usa también mensaje hola y establece idioma fr.",
      ...
      "Tras recibir la herramienta, comunica únicamente el campo respuesta. Si idioma es en, tradúcelo fielmente a inglés natural; si es fr, tradúcelo fielmente a francés natural; si es es, mantenlo en español. Nunca cambies fechas, horas, personas, zonas, nombres, teléfonos ni localizadores.",
