...
const normalizarZonasPublicasRestaurante = typeof require === "function"
  ? require("./zona-reserva").normalizarZonasPublicas
  : window.ContactiaZonas.normalizarZonasPublicas;
...
function normalizarRestaurantePublico(campos, slugEsperado = "") {
  ...
  return {
    ...
    zonas: normalizarZonasPublicasRestaurante(campos?.zonas)
  };
}
